...
import com.cos.blog.auth.PrincipalDetailsService;
import com.cos.blog.model.User;
import com.cos.blog.model.kakao.KakaoModel;
import com.cos.blog.model.kakao.OAuth2Token;
...
public class KakaoController {
	...
	private String clientId = "266b4a6be00c8fdafcee516a0bf73c11";
	...
	@Autowired
	PrincipalDetailsService mMyUserDetailService;
	...
	// accessToken 역할 = 카카오에 정보를 받기 위한 key (10분 ~ 1시간)
		...
		public String kakaoCallback(
			...
			headers2.add("Authorization", "Bearer "+oToken.getAccess_token()); //전부다 String형일 때. RestTemplate 때문에 생략가능
			headers2.add("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"); //전부다 String형일 때. RestTemplate 때문에 생략가능
